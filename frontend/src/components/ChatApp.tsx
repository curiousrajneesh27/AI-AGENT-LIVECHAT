      ...
      setMessages([
        {
          id: 'welcome',
          sender: 'ai',
          text: `Hi ${user?.name || 'there'}! 👋 I'm your virtual support agent for TechGadget Store. I'm here to help with shipping, returns, product information, and any other questions you might have. How can I assist you today?`,
      ...
      setMessages([
        {
          id: 'welcome',
          sender: 'ai',
          text: `Hi ${user?.name || 'there'}! 👋 I'm your virtual support agent for TechGadget Store. How can I help you today?`,
          timestamp: new Date().toISOString(),
        },
      ]);
    }
